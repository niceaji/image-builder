...
MEME.MemeCanvasView = Backbone.View.extend({
  ...
  render: function() {
    ...
    var size = d.canvasSize.split('x');

    // Reset canvas display:
    this.canvas.width = d.width = size[0];
    this.canvas.height = d.height = size[1];
    ...
    function renderHeadline(ctx) {
      ...
      var drawString = function (ctx, text, x, y, fontSize) {
      ...
      //ctx.fillText(line, x, y);
      drawString(ctx, d.headlineText, x, y, d.fontSize);
